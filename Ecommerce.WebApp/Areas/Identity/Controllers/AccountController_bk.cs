...
namespace Ecommerce.Identity.Areas.Identity.Controllers
{
    ...
    public class AccountController_bk : Controller
    {
        private UserManager<AppUser> _usermanager { get; }
        private SignInManager<AppUser> _signinmanager { get; }
        private readonly ILogger<AccountController_bk> _logger;
        private readonly Appsettings _appsettings;
        private IEmailSender _emailSender;
        public AccountController_bk(UserManager<AppUser> usermanager, SignInManager<AppUser> signinmanager, ILogger<AccountController_bk> logger, IEmailSender emailSender, IOptions<Appsettings> appsettings)
        {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(AccountController_bk.Login), "Account");
        }
        [HttpGet]
